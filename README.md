The project provides a simple encoder and decoder functionality using a predefined symbol table (symTable). Users can enter text to be encoded or a series of encoded integers to be decoded. Encoding:
